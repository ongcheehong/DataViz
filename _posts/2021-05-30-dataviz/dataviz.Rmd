...
3. Malaysia trade with Singapore has a **steep decrease in the month of Jan 2020 to Apr 2020**. The decrease might be due to the possibility of a border closure between Singapore and Malaysia during the Covid-19 period. However, to avoid the **storytelling bug**, no annotation will be written on this possibility.
